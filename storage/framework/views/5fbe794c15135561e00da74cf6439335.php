...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('nombre', $descuento->nombre)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('codigo', $descuento->codigo)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="fijo"       <?php echo e(old('tipo', $descuento->tipo) === 'fijo'       ? 'selected' : ''); ?>>Valor fijo ($)</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('valor', $descuento->valor)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('fecha_inicio', $descuento->fecha_inicio->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('fecha_fin', $descuento->fecha_fin->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('uso_maximo', $descuento->uso_maximo)); ?>" placeholder="Sin límite">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('uso_cliente_maximo', $descuento->uso_cliente_maximo)); ?>" placeholder="Sin límite">
                    ...
                    <div class="col-12 d-flex gap-4 pt-1">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="aplicable_manual" value="1"
                                   <?php echo e(old('aplicable_manual', $descuento->aplicable_manual) ? 'checked' : ''); ?>>
