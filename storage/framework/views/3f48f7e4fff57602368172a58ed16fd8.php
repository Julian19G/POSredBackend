...
<?php $__env->startSection('title', 'Crear Color'); ?>

<?php $__env->startSection('content'); ?>
<div class="container">
    <h1 class="mb-4">Crear nuevo color</h1>

    <form action="<?php echo e(route('colores.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                value="<?php echo e(old('codigo_hex')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario\Documents\My Web Sites\POS\Backend\POSRed\resources\views\colores\create.blade.php ENDPATH**/ ?>