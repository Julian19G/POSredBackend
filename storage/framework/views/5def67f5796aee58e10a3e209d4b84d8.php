            ...
            <div class="row g-4">
                ...
                <div class="col-md-8">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <h3 class="card-title mb-0"><?php echo e($producto->nombre); ?></h3>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="prod-value"><?php echo e($producto->descripcion ?: 'Sin descripción disponible.'); ?></div>
                    </div>

                    <div class="row g-3">
                        <div class="col-sm-6">
                            <span class="prod-label">Stock</span>
                            <div class="prod-value"><?php echo e($producto->stock); ?></div>
                        </div>
                        <div class="col-sm-6">
                            <span class="prod-label">Categoría</span>
                            <div class="prod-value"><?php echo e($producto->categoria ? $producto->categoria->nombre : 'Sin categoría'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
