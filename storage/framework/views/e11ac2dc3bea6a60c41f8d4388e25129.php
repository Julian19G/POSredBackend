            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-2">
                        Comparte este link. Las ventas que se hagan a través de él se le atribuyen a <?php echo e($vendedor->nombre); ?>.
                    </p>
                    <div class="input-group input-group-sm">
                        <input type="text" id="enlace-referido" class="form-control"
                               value="<?php echo e($vendedor->enlace_referido); ?>" readonly>
                        <button type="button" class="btn btn-outline-primary" id="btn-copiar-enlace">
                            Copiar
                        </button>
                    </div>
                    <div class="small text-muted mt-2">
                        Código: <code><?php echo e($vendedor->codigo); ?></code>
                    </div>
                </div>
            </div>
