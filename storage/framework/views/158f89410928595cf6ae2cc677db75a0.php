...
unset($__errorArgs, $__bag); ?>"
               value="<?php echo e(old('fecha_nacimiento', isset($cliente->fecha_nacimiento) ? $cliente->fecha_nacimiento->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                   placeholder="300 123 4567" value="<?php echo e(old('telefono', $cliente->telefono ?? '')); ?>" required>
        </div>
...
unset($__errorArgs, $__bag); ?>"
                   placeholder="300 123 4567" value="<?php echo e(old('whatsapp', $cliente->whatsapp ?? '')); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>"
                   placeholder="usuario (sin @)" value="<?php echo e(old('instagram', $cliente->instagram ?? '')); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>"
               value="<?php echo e(old('ciudad', $cliente->ciudad ?? 'Cali')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="barrio" class="form-control <?php $__errorArgs = ['barrio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
               value="<?php echo e(old('barrio', $cliente->barrio ?? '')); ?>" placeholder="Ej: El Ingenio, Chipichape…">
...
unset($__errorArgs, $__bag); ?>"
               value="<?php echo e(old('direccion', $cliente->direccion ?? '')); ?>" placeholder="Calle, número, apto…">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6">
        ...
        <select name="referido_por" class="form-select <?php $__errorArgs = ['referido_por'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                  rows="2" placeholder="Preferencias, notas de entrega, historial…"><?php echo e(old('notas', $cliente->notas ?? '')); ?></textarea>
