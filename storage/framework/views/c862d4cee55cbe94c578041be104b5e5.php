...
<div class="container" style="max-width:580px">
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-body p-4">
            <form action="<?php echo e(route('domiciliarios.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="telefono" class="form-control"
                           value="<?php echo e(old('telefono')); ?>" placeholder="300 000 0000">
                </div>

                <div class="mb-3">
                    <label class="form-label">Vehículo <span class="text-danger">*</span></label>
                    <select name="vehiculo" class="form-select <?php $__errorArgs = ['vehiculo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                        <?php $__currentLoopData = ['moto' => '🏍 Moto', 'bicicleta' => '🚲 Bicicleta', 'pie' => '🚶 A pie', 'carro' => '🚗 Carro']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(old('vehiculo') === $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('domiciliarios.index')); ?>" class="btn btn-outline-secondary">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario\Documents\My Web Sites\POS\Backend\POSRed\resources\views\domiciliarios\create.blade.php ENDPATH**/ ?>