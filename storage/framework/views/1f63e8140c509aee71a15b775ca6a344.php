...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-3">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('ventas.recibo', $venta->id)); ?>" target="_blank" class="btn btn-outline-secondary">🖨 Imprimir recibo</a>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body">
                    ...
                    <table class="table table-sm table-borderless mb-0">
                        <tr><th>Cliente</th><td><?php echo e($venta->cliente->nombre ?? '—'); ?></td></tr>
                        <tr><th>Teléfono</th><td><?php echo e($venta->cliente->telefono ?? '—'); ?></td></tr>
                        <tr><th>Vendedor</th>
                            <td>
                                <?php if($venta->vendedor): ?>
                                    <a href="<?php echo e(route('vendedores.show', $venta->vendedor->id)); ?>"><?php echo e($venta->vendedor->nombre); ?></a>
                                <?php else: ?>
                        ...
                        <tr><th>Dirección</th><td><?php echo e($venta->direccion_envio); ?></td></tr>
                        <?php endif; ?>
                        ...
                        <tr>
                            <th>Descuento
                                <?php if($venta->motivo_descuento): ?>
                                    <small class="text-muted">(<?php echo e($venta->motivo_descuento); ?>)</small>
                                <?php endif; ?>
                            </th>
