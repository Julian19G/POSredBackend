...
<div class="container py-4" style="max-width:880px">
    ...
    <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data" id="producto-form">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="stock" class="form-control" value="{{ old('stock') }}" step="any" min="0" required>
            <small class="text-muted">La disponibilidad de cada presentación se calcula sola (ej. 450 ÷ 10 = 45 paquetes x10).</small>
        </div>

        <div class="mb-3">
            <label class="form-label">Categoría</label>
            <select name="categoria_id" id="categoria_select" class="form-select" data-flores="{{ $floresId }}">
