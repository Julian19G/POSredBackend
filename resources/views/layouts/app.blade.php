    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="navbarPOS">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                {{-- Catálogo: productos + configuración del catálogo --}}
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->routeIs('productos.*') || request()->routeIs('inventarios.*') || request()->routeIs('categorias.*') || request()->routeIs('presentaciones.*') || request()->routeIs('tipos-flor.*') ? 'active fw-semibold' : '' }}"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @if(auth()->user()->isAdmin())
                            ...
                            <li><a class="dropdown-item" href="{{ route('categorias.index') }}">🗂️ Categorías</a></li>
                            <li><a class="dropdown-item" href="{{ route('presentaciones.index') }}">📦 Presentaciones</a></li>
                            <li><a class="dropdown-item" href="{{ route('tipos-flor.index') }}">🌸 Tipos de flor</a></li>
                        @endif
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->routeIs('descuentos.*') || request()->routeIs('users.*') || request()->routeIs('tunnel.*') ? 'active fw-semibold' : '' }}"
                       href="#" role="button" data-bs-toggle="dropdown">
                        ⚙️ Administración
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('descuentos.index') }}">🎟️ Descuentos</a></li>
                        <li><a class="dropdown-item" href="{{ route('tunnel.index') }}">🌐 Publicar tienda (túnel)</a></li>
                        <li><hr class="dropdown-divider"></li>
...
{{-- Tema claro/oscuro: toggle + persistencia --}}
<script>
(function () {
...
{{-- Notificaciones del panel: poller + alerta del SO --}}
@auth
<script>
(function () {
