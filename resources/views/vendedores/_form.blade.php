    ...
    <div class="col-12 border-top pt-3 mt-2">
        ...
        <div class="mt-2" id="vehiculo-wrap">
            ...
            <select name="vehiculo" class="form-select">
                @foreach(['moto' => 'Moto', 'bicicleta' => 'Bicicleta', 'pie' => 'A pie', 'carro' => 'Carro'] as $value => $label)
                    <option value="{{ $value }}" {{ old('vehiculo', $vendedor->domiciliario?->vehiculo ?? 'moto') === $value ? 'selected' : '' }}>{{ $label }}</option>
                @endforeach
            </select>
        </div>
