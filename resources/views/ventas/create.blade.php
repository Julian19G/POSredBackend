                            ...
                            <div class="col-md-5">
                                ...
                                <select name="vendedor_id" id="vendedor_select" class="form-select">
                                    ...
                                    @foreach($vendedores as $v)
                                        <option value="{{ $v->id }}"
                                            {{ old('vendedor_id') == $v->id ? 'selected' : '' }}>
                                            {{ $v->nombre }}
                                            @if($v->comision_porcentaje > 0)
                            ...
                            <select name="descuento_id" id="descuento_id" class="form-select">
                                ...
                                @foreach($descuentos as $d)
                                    <option value="{{ $d->id }}"
                                        ...
                                        data-valor="{{ $d->valor }}">
                                        {{ $d->nombre }}
                                        @if($d->codigo) ({{ $d->codigo }}) @endif
                                        —
                                        @if($d->tipo === 'porcentaje') {{ $d->valor }}%
                                        @else ${{ number_format($d->valor, 2, ',', '.') }}
                                        @endif
                                    </option>
                                @endforeach
                            </select>
