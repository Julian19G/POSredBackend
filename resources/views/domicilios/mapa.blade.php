...
<div class="container-fluid py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <small class="text-muted">Cali, Colombia — {{ $domicilios->count() }} domicilio(s) en ruta</small>
        </div>
        <a href="{{ route('domicilios.index') }}" class="btn btn-outline-secondary btn-sm">← Lista</a>
    </div>
...
<script>
const DOMICILIOS = @json($domicilios);
